    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-black p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          <Link
            href="/admin/upload"
            className="bg-gradient-to-br from-blue-600 to-blue-800 hover:from-blue-500 hover:to-blue-700 p-8 rounded-2xl transition-all transform hover:scale-105 shadow-2xl group"
          >
          ...
          <Link
            href="/admin/frames"
            className="bg-gradient-to-br from-purple-600 to-purple-800 hover:from-purple-500 hover:to-purple-700 p-8 rounded-2xl transition-all transform hover:scale-105 shadow-2xl group"
          >
            <div className="text-6xl mb-4">🎬</div>
          ...
          <Link
            href="/admin/packs"
            className="bg-gradient-to-br from-green-600 to-green-800 hover:from-green-500 hover:to-green-700 p-8 rounded-2xl transition-all transform hover:scale-105 shadow-2xl group"
          >
            <div className="text-6xl mb-4">📦</div>
